# Worked Example A — The OpenAI–Hugging Face Incident (April–July 2026)

*A worked example of the [Agentic-AI Containment RCSA](../../README.md) instrument. Compiled solely from public sources; ratings are the author's own and are indicative, not an audited assessment. **Not affiliated with, authorised by, or endorsed by OpenAI or Hugging Face.***

**▶ [Open the interactive matrix](https://socragpt.github.io/agentic-ai-containment-rcsa/examples/openai-hugging-face-2026/matrix.html)** · [Report (PDF)](report.pdf) · [Report (Word)](report.docx) · [Workbook](instrument.xlsx)
...
*Inherent = L × I. Residual reflects controls as operated during the incident. Appetite ceiling and status per [Part I.B](../../README.md#b-risk-appetite--tolerance).*
...
*This is an independent case study compiled solely from public information. Ratings are the author's own, are indicative, and do not represent an audited assessment. Not affiliated with, authorised by, or endorsed by OpenAI or Hugging Face. © 2026 socragpt. Licensed under [CC BY 4.0](../../LICENSE).*
